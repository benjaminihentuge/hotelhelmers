        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-300 leading-relaxed">
              Welcome! Here, we dont do the conventional; we do fun and loyalty...
              Known in the heart of Abuja for spaces, services, food, and drinks
              that bring the magic. If youre a fan of stylish hotels with a true
              tourist experience, youll be right at home with us.
            </p>
            <p className="mt-4 text-gray-300 leading-relaxed">
